...
namespace PIKA.Modelo.Contacto
{
    ...
    public class ValidadorTipoFuenteContacto : AbstractValidator<TipoFuenteContacto>
    {
        public ValidadorTipoFuenteContacto(IStringLocalizer<TipoFuenteContacto> localizer) {
