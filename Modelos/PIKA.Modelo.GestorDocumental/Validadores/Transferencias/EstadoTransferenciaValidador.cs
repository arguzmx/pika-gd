...
{
    public class EstadoTransferenciaValidador : AbstractValidator<EstadoTransferencia>
    {
        public EstadoTransferenciaValidador(IStringLocalizer<EstadoTransferencia> localizer)
        {
            RuleFor(x => x.Nombre)
