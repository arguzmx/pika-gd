...
class editorTabular {
        ...
        this.client.getMetadata().then((respuesta) => {
            if (!respuesta.es_error) {
                ...
                this.table = this.generaTabla(this.propiedades,
                    ...
                    "http://localhost:5000/api/v1.0/seguridad/Aplicacion/datatables");
    ...
    generaTabla(propiedades, url) {
        ...
        let t = $('#tablaeditortabular').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "http://localhost:5000/api/v1.0/cont/elemento/datatables",
                'headers': {
...
$(function () {
    ...
    //metadatos
    var editor = new editorTabular("http://localhost:5000/api/v1.0/cont/elemento/");
