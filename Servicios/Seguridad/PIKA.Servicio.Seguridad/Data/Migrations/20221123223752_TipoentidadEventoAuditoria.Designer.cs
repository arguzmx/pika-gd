...
namespace PIKA.Servicio.Seguridad.data.migrations
{
    ...
    [Migration("20221123223752_TipoentidadEventoAuditoria")]
    partial class TipoentidadEventoAuditoria
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PIKA.Infraestructura.Comun.ModuloAplicacion", b =>
                {
                    ...
                    b.Property<int>("PermisosDisponibles")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PIKA.Infraestructura.Comun.Seguridad.Auditoria.TipoEventoAuditoria", b =>
                {
                    b.Property<string>("FuenteEventoId")
                        .HasColumnType("varchar(128) CHARACTER SET utf8mb4")
                        .HasMaxLength(128);
                    ...
                    b.Property<string>("Desripción")
                        .IsRequired()
                        .HasColumnType("varchar(500) CHARACTER SET utf8mb4")
                        .HasMaxLength(500);

                    b.Property<string>("PlantillaEvento")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.HasKey("FuenteEventoId", "TipoEvento", "ModuloId");

                    b.ToTable("seguridad$tipoeventosaud");
                });
            ...
            modelBuilder.Entity("PIKA.Modelo.Seguridad.ValorClaveUsuario", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(128) CHARACTER SET utf8mb4")
                        .HasMaxLength(128);
                    ...
                    b.ToTable("seguridad$valorclave");
                });
