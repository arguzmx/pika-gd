...
namespace PIKA.Servicio.Contenido.Servicios.TareasAutomaticas
{
    ...
    public class TareaExportarPDF : IInstanciaTareaEnDemanda
    {
        ...
        CancellationToken stoppingToken)
        {
            ...
            resultado = new ResultadoTareaAutomatica(DominioId) { PayloadOutput =null,  Error = null, Exito = false, Id = Id, SegundosDuracion = 0 };
        }


        public async Task<ResultadoTareaAutomatica> EjecutarTarea(string InputPayload)
        {
