...
namespace PIKA.Servicio.Organizacion.Data
{
       ...
       IEntityTypeConfiguration<DireccionPostal>
    {
        public void Configure(EntityTypeBuilder<DireccionPostal> builder)
        {
            ...
            builder.Property(x => x.Nombre).HasMaxLength(LongitudDatos.Nombre).IsRequired(false);
            ...
            builder.Property(x => x.Calle).HasMaxLength(LongitudDatos.Nombre).IsRequired(false);
            ...
            builder.Property(x => x.EstadoId).HasMaxLength(LongitudDatos.GUID).IsRequired(false);
            ...
            builder.Property(x => x.PaisId).HasMaxLength(LongitudDatos.GUID).IsRequired(false);
