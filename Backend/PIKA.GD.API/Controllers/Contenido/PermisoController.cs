...
namespace PIKA.GD.API.Controllers.Contenido
{
    ...
    public class PermisoController : ACLController
    {

        private ILogger<PermisoController> logger;
        private IServicioPermiso servicioEntidad;
        private IProveedorMetadatos<Permiso> metadataProvider;
        public PermisoController(ILogger<PermisoController> logger,
            IProveedorMetadatos<Permiso> metadataProvider,
            IServicioPermiso servicioEntidad)
        {
            this.logger = logger;
        ...
        /// </summary>
        /// <returns></returns>
        [HttpGet("metadata", Name = "MetadataPermisoContenid")]
        ...
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<ActionResult<Permiso>> Post([FromBody]Permiso entidad)
        {
        ...
        public async Task<IActionResult> Put(string id, [FromBody]Permiso entidad)
        {
        ...
        /// <returns></returns>
        [HttpGet("page", Name = "GetPagePermiso")]
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<ActionResult<IEnumerable<Permiso>>> GetPage([ModelBinder(typeof(GenericDataPageModelBinder))][FromQuery]Consulta query = null)
        {
