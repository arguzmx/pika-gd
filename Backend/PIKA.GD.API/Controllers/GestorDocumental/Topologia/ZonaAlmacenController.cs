...
namespace PIKA.GD.API.Controllers.GestorDocumental
{
    ...
    public class ZonaAlmacenController : ACLController
    {
        private readonly ILogger<ZonaAlmacenController> logger;
        private IServicioZonaAlmacen servicioEntidad;
        private IProveedorMetadatos<ZonaAlmacen> metadataProvider;
        public ZonaAlmacenController(ILogger<ZonaAlmacenController> logger,
            IProveedorMetadatos<ZonaAlmacen> metadataProvider,
            IServicioZonaAlmacen servicioEntidad)
        {
            this.logger = logger;
        ...
        /// </summary>
        /// <returns></returns>
        [HttpGet("metadata", Name = "MetadataZonaAlmacen")]
        ...
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<ActionResult<ZonaAlmacen>> Post([FromBody] ZonaAlmacen entidad)
        {
            entidad = await servicioEntidad.CrearAsync(entidad).ConfigureAwait(false);
            return Ok(CreatedAtAction("GetZonaAlmacen", new { id = entidad.Id }, entidad).Value);
        }
        /// <summary>
        ...
        public async Task<IActionResult> Put(string id, [FromBody] ZonaAlmacen entidad)
        {
        ...
        [HttpGet("page/almacenarchivo/{almacenarchivoid}", Name = "GetPageZonaAlmacen")]
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]

        public async Task<ActionResult<Paginado<ZonaAlmacen>>> GetPage(string almacenarchivoid,
        ...
        /// <returns></returns>
        [HttpGet("{id}", Name = "GetZonaAlmacen")]
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]

        public async Task<ActionResult<ZonaAlmacen>> GetZonaAlmacen(string id)
        {
        ...
        /// <param name="ids">Arreglo de identificadores string</param>
        /// <returns></returns>
        [HttpPatch("restaurar/{ids}", Name = "restaurarZonaAlmacen")]
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
        ...
        [HttpGet("pares", Name = "GetParesZonaAlmacen")]
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
        ...
        [HttpGet("pares/{ids}", Name = "GetParesZonaAlmacenporId")]
        [TypeFilter(typeof(AsyncACLActionFilter))]
        [ProducesResponseType(StatusCodes.Status200OK)]
