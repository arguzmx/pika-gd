...
namespace PIKA.GD.API.Controllers.Seguridad
{
    ...
    public class AplicacionController : ACLController
    {
        ...
        public async Task<ActionResult<Paginado<Aplicacion>>> GetPage([ModelBinder(typeof(GenericDataPageModelBinder))][FromQuery]Consulta query = null)
        {
            ///Añade las propiedaes del contexto para el filtro de ACL vía ACL Controller
            query.Filtros.AddRange(ObtieneFiltrosIdentidad());
            var data = await servicioAplicacion.ObtenerPaginadoAsync(
          Query: query,
          include: null)
